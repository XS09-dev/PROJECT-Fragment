...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		    ['The Fragmented Team'],
			['Hris',		'hris',		'Creator and Artist For The Mod',						'https://www.youtube.com/channel/UC6ZGllB-uJ-Esia6anfg2ug',	'1717b3'],
			['Lex',			'lex',		'Main Programmer and Charter For The Mod',					'https://gamejolt.com/@XS_09',		'FFFFFF'],
			['bakonboi',			'bakon',			'Main Musician For The Mod and a bakon boi',				'https://www.youtube.com/channel/UCSY0RLR3pvpLD79iEYr3bMA',			'66331e'],
			['ImSamity',			'samity',			'Main Artist 1',				'https://twitter.com/ImSamity',			'101020'],
			['Trippy',			'trippy',			'Main Artist 2 and Animator',				'https://youtube.com/channel/UCf4Ce6m4MrMj6sOd0iHsp5w',			'011fbd'],
			[''],
		    ['R41D Team'],
